    ...
    <div className={cn("section-divider", className)}>
      ...
      {variant === "curve" && (
        <svg
          ...
          className="fill-background dark:fill-background"
        >
          <path d="M600,112.77C268.63,112.77,0,65.52,0,7.23V0H1200V7.23C1200,65.52,931.37,112.77,600,112.77Z" />
        </svg>
      )}
      ...
      {variant === "zigzag" && (
        <svg
          ...
          className="fill-background dark:fill-background"
        >
          <path d="M0,0V7.23L0,65.52,0,7.23,0,0V7.23L240,56.3L480,7.23L720,56.3L960,7.23L1200,56.3L1200,7.23V0Z" />
        </svg>
      )}
    </div>
  )
